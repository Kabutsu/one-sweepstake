...
export default function CreateSweepstake() {
  ...
  const tournamentHasStarted = tournament && new Date(tournament.startDate) <= new Date();
      ...
      <div className="glass p-8 shadow-2xl rounded-2xl border border-white/20 dark:border-white/10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {tournamentHasStarted && (
            <div className="bg-orange-50 dark:bg-orange-900/20 border-2 border-orange-200 dark:border-orange-800 text-orange-800 dark:text-orange-200 px-4 py-3 rounded-xl flex items-start space-x-2">
              ...
              <div className="text-sm">
                <p className="font-semibold mb-1">Tournament has already started</p>
                <p>
                  You can still create a sweepstake, but some matches may have already been played.
                  Teams from completed matches will still be included in the draw.
                </p>
              </div>
            </div>
          )}
