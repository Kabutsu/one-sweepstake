  ...
  return (
    <div className="relative h-full">
      <div
        ...
        className="h-full overflow-y-auto space-y-3 pb-4 scroll-smooth scrollbar-thumb-transparent scrollbar-track-transparent scrollbar-thin hover:scrollbar-thumb-red-500"
      >
        {isLoading && hasMore && (
