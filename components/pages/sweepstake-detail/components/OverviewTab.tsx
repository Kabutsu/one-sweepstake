          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-green-700 dark:text-green-300">
                Teams have been randomly assigned to all participants. Check the Standings tab to
                see your assignments. The sweepstake is now locked and no new participants can join.
              </p>
